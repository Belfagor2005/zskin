...
config.Styles.skin_auto_update = ConfigYesNo(False)
config.Styles.data = ConfigYesNo(default=False)
config.Styles.api = ConfigText(default="PRESS OK")
config.Styles.txtapi = ConfigText(default="12345678909876543212345678909876", visible_width=50, fixed_size=False)
config.Styles.data2 = ConfigYesNo(default=False)
config.Styles.api2 = ConfigText(default="PRESS OK")
config.Styles.txtapi2 = ConfigText(default="cb1d9f55", visible_width=50, fixed_size=False)
