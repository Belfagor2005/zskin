...
# for ch,
# <widget source="ServiceEvent" render="ZPoster" position="820,100" size="100,150" path="/media/hdd/poster/" zPosition="9" />
# for secondInfobar,
# <widget source="session.Event_Now" render="ZPoster" position="20,155" size="100,150" path="/media/hdd/poster/" zPosition="9" />
