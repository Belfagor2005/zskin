...
from enigma import eLabel, eWidget, ePoint
from enigma import eSize, fontRenderClass, eTimer


class zScrollLabel(VariableText, Renderer):
    def __init__(self):
    ...
    def applySkin(self, desktop, parent):
        ...
        for attrib, value in self.skinAttributes:
            ...
            if attrib.find('font') != -1 or attrib.find('size') != -1 or attrib.find('zPosition') != -1 or attrib.find('transparent') != -1 or attrib.find(
                    'backgroundColor') != -1 or attrib.find('foregroundColor') != -1 or attrib.find('valign') != -1 or attrib.find('halign') != -1:
            ...
            if attrib.find('css') != -1:
                ...
                for style in styles:
                    for _attrib in cascadingStyleSheets[style].keys():
                        ...
                        if _attrib.find('font') != -1 or _attrib.find('size') != -1 or _attrib.find('zPosition') != -1 or _attrib.find('transparent') != -1 or _attrib.find(
                                'backgroundColor') != -1 or _attrib.find('foregroundColor') != -1 or _attrib.find('valign') != -1 or _attrib.find('halign') != -1:
